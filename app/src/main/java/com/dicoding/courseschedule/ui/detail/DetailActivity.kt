...
class DetailActivity : AppCompatActivity() {
    ...
    private fun showCourseDetail(course: Course?) {
        course?.apply {
            ...
            val detailCourse = findViewById<TextView>(R.id.tv_course_name)
            val detailTime = findViewById<TextView>(R.id.tv_time)
            val detailLecture = findViewById<TextView>(R.id.tv_lecturer)
            val detailNote = findViewById<TextView>(R.id.tv_note)

            detailCourse.text = courseName
            detailTime.text = timeFormat
            detailLecture.text = lecturer
